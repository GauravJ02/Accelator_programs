...
print(sensor.to_string(header=False,index=False),"\n")

print("Missing Values")
print(sensor.isnull().to_string(header=False,index=False),"\n")

sensor["Date"] = pd.to_datetime(sensor["Date"])

recovered = sensor.interpolate()
print("Recovered Sensor Dataset")
print(recovered.to_string(header=False,index=False),"\n")

print("Average Temperature\n")
print(recovered.mean().to_string(index=False,header=False))