...
balances_pd = pd.read_csv("balances.csv")
balances_pl = pl.read_csv("balances.csv")

print("Pandas Execution Engine Total")
print(balances_pd["Balance"].sum())
print()

print("Polars Execution Engine Total")
print(balances_pl.select(pl.col('Balance').sum()).item())
