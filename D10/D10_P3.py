...
print(employees.to_string(header=False,index=False),"\n")

print("Missing Values\n")
is_null = employees.isnull()
print(is_null.to_string(index=False,header=False),"\n")

print("Updated Employee Dataset\n")
average_salary = employees.mean()
employees = employees.fillna(average_salary)
print(employees.to_string(header=False,index=False),"\n")
